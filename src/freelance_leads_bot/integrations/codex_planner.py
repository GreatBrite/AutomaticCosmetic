...
def build_codex_planner_prompt(payload: dict[str, Any], trace: list[dict[str, Any]]) -> str:
    return (
        ...
        "Не склоняй клиента на консультацию как стандартный следующий шаг. Если нужна индивидуальная оценка Ольги, не додумывай за неё: передай задачу Ольге, а клиенту попроси телефон для связи или недостающие фото/данные без обещаний результата.\n"
